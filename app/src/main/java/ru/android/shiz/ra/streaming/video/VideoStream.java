...
import ru.android.shiz.ra.streaming.Stream;
import ru.android.shiz.ra.streaming.exceptions.CameraInUseException;
import ru.android.shiz.ra.streaming.exceptions.ConfNotSupportedException;
import ru.android.shiz.ra.streaming.exceptions.InvalidSurfaceException;
import ru.android.shiz.ra.streaming.gl.SurfaceView;
import ru.android.shiz.ra.streaming.hw.EncoderDebugger;
import ru.android.shiz.ra.streaming.hw.NV21Convertor;
import ru.android.shiz.ra.streaming.rtp.MediaCodecInputStream;
...
public abstract class VideoStream extends MediaStream {
    ...
    protected synchronized void updateCamera() throws RuntimeException {
        ...
        String focus = VideoQuality.determineSupportedFocuses(parameters);
